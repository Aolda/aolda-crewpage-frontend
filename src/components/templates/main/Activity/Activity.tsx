        ...
        >
            <S.ActivityWrapper>
                ...
                <S.TabContainer>
                    <S.Tab>
                        <h2>활동 원칙</h2>
                        <p>아올다는 모든 소학회 구성원들이 <span>학기 당 최소 1개 이상<br className="pc-only"/>활동에 참여하는 것을 원칙</span>으로 합니다. <br className="pc-only"/>
                        개발 프로젝트, 스터디 등 희망하는 활동에 참여하거나, <br className="pc-only"/>직접 기획하여 진행할 수 있습니다</p>
                    </S.Tab>
                    <S.Tab>
                        <h2>정기 활동</h2>
                        <p><span>아올다는 매월 2, 4주차 월요일 19시에 정기모임을 진행합니다. </span><br className="pc-only"/>운영과 관련된 다양한 문제를 논의하고,
                        <br className="pc-only"/>각자 진행중인 프로젝트를 공유하며, <br className="pc-only"/>
